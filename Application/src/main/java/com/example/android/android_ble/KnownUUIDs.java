...
//Modified from the Adafruit BLE Connect app.
...
public class KnownUUIDs extends StandardUUIDs {
    ...
    static {
        ...
        // Uart
        aMap.put(BluetoothLeService.UUID_RX.toUpperCase(), "RX Buffer");
        aMap.put(BluetoothLeService.UUID_TX.toUpperCase(), "TX Buffer");
        aMap.put(BluetoothLeService.UUID_DFU.toUpperCase(), "DFU Service");
